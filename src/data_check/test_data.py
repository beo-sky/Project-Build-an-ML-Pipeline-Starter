...
def test_row_count(data):
    """
    Test if set of dataset is reasonable in size (not to big not too small).
    """
    assert 15000 < data.shape[0] < 10000000

def test_price_range(data, min_price, max_price):
    """
    Test to ensure data price is between the range of the minimum and maximum price.
    """
